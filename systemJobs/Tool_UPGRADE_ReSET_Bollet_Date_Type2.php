<?php
  ...
  */
  ...
  try{
	...
	// 修 1031後的資料  17 號抽
	$DB_OBJ = $db->DBLink->prepare( "SELECT * FROM area_booking WHERE _status='收件待審' AND _ballot=1 AND date_enter >= '2019-10-31'  AND _keep=1 ORDER BY am_id ASC,date_enter ASC,abno ASC;");
